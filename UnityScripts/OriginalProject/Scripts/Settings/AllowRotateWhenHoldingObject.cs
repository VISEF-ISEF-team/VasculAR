...
public class AllowRotateWhenHoldingObject : MonoBehaviour
{
    ...
    private void Start()
    {
        elfGrabbable = GetComponent<XRGrabInteractable>();
        selfGrabbable.selectEntered.AddEventListener(OnSelectEnter);
        selfGrabbable.selectExited.AddEventListener(OnSelectExit);
    }

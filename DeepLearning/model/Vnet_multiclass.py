...
def CreateVnet():
    ...
    # Build the model
    inputs = tf.keras.layers.Input(sahpe=(None, None, None, 1))
    ...
    u6 = tf.keras.layers.Conv3DTranspose(
        256, (2, 2, 2), strides=2, padding="same")(a6)
    ...
    u7 = tf.keras.layers.Conv3DTranspose(
        128, (2, 2, 2), strides=2, padding="same")(a7)
    ...
    u8 = tf.keras.layers.Conv3DTranspose(
        64, (2, 2, 2), strides=2, padding="same")(a8)

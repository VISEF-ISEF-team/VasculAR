...
def show_mesh(path):
    meshes = []
    colors = ['#f1d691', '#b17a65', '#6fb8d2', '#d8654f', '#b17a65', '#b17a65', '#b17a65',  '#fc8184', '#0d05ff', '#e6dc46', '#fa0101', '#f4d631', '#fc8184', '#90ee90', '#0d05ff', '#0d05ff', '#0d05ff']
    textures = ['cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg', 'cardiac_texture_3.jpg']
...
show_mesh('D:/Documents/GitHub/VascuIAR/DeepLearning/data/VnRawData/SegmentationData/ct_0035_label_resized/')

...
class rendering:
    ...
    def load_mesh(self, filename, color):
    ...
    def show_mesh(self):
        ...
        mesh1 = self.load_mesh("static/data/res_recon_full_seg/cardiac_class_1.stl", "#800000")
        mesh2 = self.load_mesh("static/data/res_recon_full_seg/cardiac_class_2.stl", "#FF8080")
        mesh3 = self.load_mesh("static/data/res_recon_full_seg/cardiac_class_3.stl", "#FFA500")
        mesh4 = self.load_mesh("static/data/res_recon_full_seg/cardiac_class_4.stl", "#800080")
        mesh5 = self.load_mesh("static/data/res_recon_full_seg/cardiac_class_5.stl", "#FF0000")
        mesh6 = self.load_mesh("static/data/res_recon_full_seg/cardiac_class_6.stl", "#FFC0CB")
        mesh7 = self.load_mesh("static/data/res_recon_full_seg/cardiac_class_7.stl", "#0000FF")    
    ...
    def segmented_reconstruction(self):
        whole_heart = sitk.ReadImage(self.output_path, sitk.sitkFloat32)
        ...
        for i, label_array in enumerate(label_arrays): 
            ...
            # Save the STL file with the name and the path
            obj_3d.save(f'static/data/res_recon_full_seg/cardiac_class_{i}.stl')
            
        # Load mesh and display reconstructed 3D with different colors
        self.show_mesh()
        
    def show_mesh_12(self):
        # Define a function that toggles the transparency of a mesh and changes the button state
        def buttonfunc1():
            mesh1.alpha(1 - mesh1.alpha())  
            bu1.switch()                  
        ...
        def buttonfunc12():
            ...
            # Load the meshes from the files and assign different colors
        mesh1 = self.load_mesh("static/data/3D_res_3/Segmentation_1_aeorta.stl", "#fc8184")
        mesh2 = self.load_mesh("static/data/3D_res_3/Segmentation_1_aeortic arch.stl", "#fa0101")
        mesh3 = self.load_mesh("static/data/3D_res_3/Segmentation_1_bicuspid valve.stl", "#dd8265")
        mesh4 = self.load_mesh("static/data/3D_res_3/Segmentation_1_IVC.stl", "#e6dc46")
        mesh5 = self.load_mesh("static/data/3D_res_3/Segmentation_1_left atrium.stl", "#f1d691")
        mesh6 = self.load_mesh("static/data/3D_res_3/Segmentation_1_left ventricle.stl", "#b17a65")
        mesh7 = self.load_mesh("static/data/3D_res_3/Segmentation_1_pericardium.stl", "#dcf514")
        mesh8 = self.load_mesh("static/data/3D_res_3/Segmentation_1_pulmonary artery.stl", "#f4d631")
        mesh9 = self.load_mesh("static/data/3D_res_3/Segmentation_1_right atrium.stl", "#6fb8d2")
        mesh10 = self.load_mesh("static/data/3D_res_3/Segmentation_1_right ventricle.stl", "#d8654f")
        mesh11 = self.load_mesh("static/data/3D_res_3/Segmentation_1_SVC.stl", "#0d05ff")
        mesh12 = self.load_mesh("static/data/3D_res_3/Segmentation_1_tricuspid valve.stl", "#90ee90")

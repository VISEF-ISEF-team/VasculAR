...
class CTkMenuBar(customtkinter.CTkFrame):
    ...
    def __init__(self, master, bg_color=["white", "black"], height=25, width=10, padx=5, pady=2, **kwargs):
        ...
        super().__init__(master, corner_radius=corner, height=height, background_corner_colors=bg_corners, **kwargs)
        self.height = height
        self.width = width
        self.after(10)
        self.num = 0
    ...
    def add_cascade(self, text=None, **kwargs):
        ...
        self.menu_button.grid(row=0, column=self.num,
                              padx=(self.padx, 0), pady=self.pady)
        self.num += 1

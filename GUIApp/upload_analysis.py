...
# test the storage
analysis = input('Enter the analysis filename: ')
patient_name = input('Enter patient name: ') # this will take from the dcm reading file
patient_name = os.path.join('Benhvienhoanmy', 'CT_chest', patient_name)
storage.child(patient_name).put(analysis)